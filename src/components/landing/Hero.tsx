...
export function Hero() {
  return (
    <section className="relative w-full flex flex-col items-center justify-center overflow-hidden pt-24 pb-20">
      {/* Background Effects */}
      ...
      <div className="relative z-10 w-full">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="w-full min-h-[60vh] flex flex-col items-center justify-center text-center">
            ...
            {/* Title */}
            <h1
              className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold tracking-tight mb-4 md:mb-6 animate-fade-in-up"
            ...
            {/* Subtitle */}
            <p
              className="text-sm sm:text-base md:text-lg lg:text-xl text-muted-foreground max-w-2xl mb-6 md:mb-8 animate-fade-in-up leading-relaxed"
            ...
            >
              <Button
                ...
                variant="hero"
                size="lg"
                className="h-11 md:h-12 text-sm md:text-base px-6 md:px-8"
              >
                <Link
                  to="/auth?mode=signup"
            ...
            {/* Trust */}
            <p
              className="mt-6 md:mt-10 text-xs md:text-sm text-muted-foreground animate-fade-in"
